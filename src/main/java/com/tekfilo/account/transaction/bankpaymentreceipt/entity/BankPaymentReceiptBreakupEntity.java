...
@Data
@Entity
@Table(name = "tbl_bank_pay_rec_breakup")
public class BankPaymentReceiptBreakupEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "bankdetbreakup_generator")
    @SequenceGenerator(name = "bankdetbreakup_generator", sequenceName = "tbl_bank_pay_rec_breakup_seq", allocationSize = 1)
