...
@Data
@Entity
@Table(name = "tbl_cash_pay_rec_breakup")
public class CashPaymentReceiptBreakupEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "cashdetbreakup_generator")
    @SequenceGenerator(name = "cashdetbreakup_generator", sequenceName = "tbl_cash_pay_rec_breakup_seq", allocationSize = 1)
