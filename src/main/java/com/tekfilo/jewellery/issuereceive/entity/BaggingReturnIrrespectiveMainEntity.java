...
@Setter
@Entity
@Table(name = "tbl_bagging_return_irrespective_main")
public class BaggingReturnIrrespectiveMainEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "bagging_irres_ret_main_generator")
    @SequenceGenerator(name = "bagging_irres_ret_main_generator", sequenceName = "tbl_bagging_return_irrespective_main_seq", allocationSize = 1)
