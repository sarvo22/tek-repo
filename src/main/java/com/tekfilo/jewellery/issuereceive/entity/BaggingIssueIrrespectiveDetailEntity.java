...
@Setter
@Entity
@Table(name = "tbl_bagging_issue_irrespective_det")
public class BaggingIssueIrrespectiveDetailEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "bagging_issue_irres_det_generator")
    @SequenceGenerator(name = "bagging_issue_irres_det_generator", sequenceName = "tbl_bagging_issue_respective_det_seq", allocationSize = 1)
