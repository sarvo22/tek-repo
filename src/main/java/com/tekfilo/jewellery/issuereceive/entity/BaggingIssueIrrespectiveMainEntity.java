...
@Setter
@Entity
@Table(name = "tbl_bagging_issue_irrespective_main")
public class BaggingIssueIrrespectiveMainEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "bagging_irres_main_generator")
    @SequenceGenerator(name = "bagging_irres_main_generator", sequenceName = "tbl_bagging_issue_irrespective_main_seq", allocationSize = 1)
