...
@Setter
@Entity
@Table(name = "tbl_bagging_return_respective_det")
public class BaggingReturnRespectiveDetailEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "bagging_return_res_det_generator")
    @SequenceGenerator(name = "bagging_return_res_det_generator", sequenceName = "tbl_bagging_return_respective_det_seq", allocationSize = 1)
