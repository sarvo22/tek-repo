...
@Setter
@Entity
@Table(name = "tbl_bagging_return_irrespective_det")
public class BaggingReturnIrrespectiveDetailEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "bagging_return_irres_det_generator")
    @SequenceGenerator(name = "bagging_return_irres_det_generator", sequenceName = "tbl_bagging_return_respective_det_seq", allocationSize = 1)
