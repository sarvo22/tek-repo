...
@Setter
@Entity
@Table(name = "tbl_bagging_issue_respective_main")
public class BaggingIssueRespectiveMainEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "bagging_res_main_generator")
    @SequenceGenerator(name = "bagging_res_main_generator", sequenceName = "tbl_bagging_issue_respective_main_seq", allocationSize = 1)
