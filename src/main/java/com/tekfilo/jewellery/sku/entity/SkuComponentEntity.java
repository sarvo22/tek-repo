...
@Setter
@Entity
@Table(name = "tbl_sku_component")
public class SkuComponentEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "skucomp_generator")
    @SequenceGenerator(name = "skucomp_generator", sequenceName = "tbl_sku_component_seq", allocationSize = 1)
    @Column(name = "sku_component_id", updatable = false, insertable = true, nullable = false)
    private Integer id;
