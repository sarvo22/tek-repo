...
@NoArgsConstructor
@Entity
@Table(name = "tbl_goods_outward_det")
public class GoodsOutwardDetailEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "goodsoutwarddet_generator")
    @SequenceGenerator(name = "goodsoutwarddet_generator", sequenceName = "tbl_goods_outward_det_seq", allocationSize = 1)
