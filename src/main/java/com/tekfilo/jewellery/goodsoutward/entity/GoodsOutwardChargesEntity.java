package com.tekfilo.jewellery.goodsoutward.entity;
...
@NoArgsConstructor
@Entity
@Table(name = "tbl_goods_outward_chgs")
public class GoodsOutwardChargesEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "goodsoutwardchgs_generator")
    @SequenceGenerator(name = "goodsoutwardchgs_generator", sequenceName = "tbl_goods_outward_chgs_seq", allocationSize = 1)
