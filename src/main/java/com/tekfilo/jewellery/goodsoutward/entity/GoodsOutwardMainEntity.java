...
@Setter
@Entity
@Table(name = "tbl_goods_outward_main")
public class GoodsOutwardMainEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "outward_generator")
    @SequenceGenerator(name = "outward_generator", sequenceName = "tbl_goods_outward_main_seq", allocationSize = 1)
