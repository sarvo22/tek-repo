...
@Setter
@Entity
@Table(name = "tbl_stud_invoice_component")
public class StudInvoiceComponentEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "studcomponent_generator")
    @SequenceGenerator(name = "studcomponent_generator", sequenceName = "tbl_stud_invoice_component_seq", allocationSize = 1)
