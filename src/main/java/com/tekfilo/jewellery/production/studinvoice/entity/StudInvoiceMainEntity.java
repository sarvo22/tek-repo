...
@Setter
@Entity
@Table(name = "tbl_stud_invoice_main")
public class StudInvoiceMainEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "studinvoicemain_generator")
    @SequenceGenerator(name = "studinvoicemain_generator", sequenceName = "tbl_stud_invoice_main_seq", allocationSize = 1)
