...
@Setter
@Entity
@Table(name = "tbl_factory_invoice_main")
public class FactoryInvoiceMainEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "factoryinvoicemain_generator")
    @SequenceGenerator(name = "factoryinvoicemain_generator", sequenceName = "tbl_factory_invoice_main_seq", allocationSize = 1)
