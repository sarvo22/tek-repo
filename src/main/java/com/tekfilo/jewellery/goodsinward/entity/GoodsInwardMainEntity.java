...
@Setter
@Entity
@Table(name = "tbl_goods_inward_main")
public class GoodsInwardMainEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "inward_generator")
    @SequenceGenerator(name = "inward_generator", sequenceName = "tbl_goods_inward_main_seq", allocationSize = 1)
