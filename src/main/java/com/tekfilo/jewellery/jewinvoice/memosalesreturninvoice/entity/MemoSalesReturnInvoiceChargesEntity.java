...
@NoArgsConstructor
@Entity
@Table(name = "tbl_jew_memo_sales_return_invoice_chgs")
public class MemoSalesReturnInvoiceChargesEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "memosalesretinvoicechgs_generator")
    @SequenceGenerator(name = "memosalesretinvoicechgs_generator", sequenceName = "tbl_jew_memo_sales_return_invoice_chgs_seq", allocationSize = 1)
