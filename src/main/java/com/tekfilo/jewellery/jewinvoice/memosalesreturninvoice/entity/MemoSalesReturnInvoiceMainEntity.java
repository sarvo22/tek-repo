...
@Setter
@Entity
@Table(name = "tbl_jew_memo_sales_return_invoice_main")
public class MemoSalesReturnInvoiceMainEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "memosalesretinvoicemain_generator")
    @SequenceGenerator(name = "memosalesretinvoicemain_generator", sequenceName = "tbl_jew_memo_sales_return_invoice_main_seq", allocationSize = 1)
