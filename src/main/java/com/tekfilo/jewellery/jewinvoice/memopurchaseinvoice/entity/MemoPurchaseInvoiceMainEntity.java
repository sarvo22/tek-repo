...
@Setter
@Entity
@Table(name = "tbl_jew_memo_purchase_invoice_main")
public class MemoPurchaseInvoiceMainEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "jewmemopurchaseinvoicemain_generator")
    @SequenceGenerator(name = "jewmemopurchaseinvoicemain_generator", sequenceName = "tbl_jew_memo_purchase_invoice_main_seq", allocationSize = 1)
