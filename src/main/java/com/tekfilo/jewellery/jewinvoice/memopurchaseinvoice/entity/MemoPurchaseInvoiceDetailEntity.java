package com.tekfilo.jewellery.jewinvoice.memopurchaseinvoice.entity;
...
@NoArgsConstructor
@Entity
@Table(name = "tbl_jew_memo_purchase_invoice_det")
public class MemoPurchaseInvoiceDetailEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "jewmemopurchaseinvoicedet_generator")
    @SequenceGenerator(name = "jewmemopurchaseinvoicedet_generator", sequenceName = "tbl_jew_memo_purchase_invoice_det_seq", allocationSize = 1)
    ...
    private MemoPurchaseInvoiceMainEntity purchaseInvoiceMain;
