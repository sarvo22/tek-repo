...
@Setter
@Entity
@Table(name = "tbl_jew_memo_sales_invoice_main")
public class MemoSalesInvoiceMainEntity {
    ...
    @SequenceGenerator(name = "memosalesinvoicemain_generator", sequenceName = "tbl_jew_memo_sales_invoice_main_seq", allocationSize = 1)
