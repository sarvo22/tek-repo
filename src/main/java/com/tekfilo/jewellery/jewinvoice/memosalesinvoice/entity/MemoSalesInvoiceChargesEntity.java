...
@NoArgsConstructor
@Entity
@Table(name = "tbl_jew_memo_sales_invoice_chgs")
public class MemoSalesInvoiceChargesEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "memosalesinvoicechgs_generator")
    @SequenceGenerator(name = "memosalesinvoicechgs_generator", sequenceName = "tbl_jew_memo_sales_invoice_chgs_seq", allocationSize = 1)
