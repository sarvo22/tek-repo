package com.tekfilo.jewellery.jewinvoice.purchaseinvoice.entity;
...
@Setter
@Entity
@Table(name = "tbl_jew_purchase_invoice_main")
public class PurchaseInvoiceMainEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "jewpurchaseinvoicemain_generator")
    @SequenceGenerator(name = "jewpurchaseinvoicemain_generator", sequenceName = "tbl_jew_purchase_invoice_main_seq", allocationSize = 1)
