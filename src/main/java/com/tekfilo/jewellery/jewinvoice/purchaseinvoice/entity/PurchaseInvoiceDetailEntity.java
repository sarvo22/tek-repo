...
@NoArgsConstructor
@Entity
@Table(name = "tbl_jew_purchase_invoice_det")
public class PurchaseInvoiceDetailEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "jewpurchaseinvoicedet_generator")
    @SequenceGenerator(name = "jewpurchaseinvoicedet_generator", sequenceName = "tbl_jew_purchase_invoice_det_seq", allocationSize = 1)
