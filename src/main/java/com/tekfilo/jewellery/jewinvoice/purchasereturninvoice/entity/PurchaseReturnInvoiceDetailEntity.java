...
@NoArgsConstructor
@Entity
@Table(name = "tbl_jew_purchase_return_invoice_det")
public class PurchaseReturnInvoiceDetailEntity {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "jewpurchaseretinvoicedet_generator")
    @SequenceGenerator(name = "jewpurchaseretinvoicedet_generator", sequenceName = "tbl_jew_purchase_return_invoice_det_seq", allocationSize = 1)
