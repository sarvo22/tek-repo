...
@Setter
@Entity
@Table(name = "tbl_jew_purchase_return_invoice_main")
public class PurchaseReturnInvoiceMainEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "jewpurchaseinvoiceretmain_generator")
    @SequenceGenerator(name = "jewpurchaseinvoiceretmain_generator", sequenceName = "tbl_jew_purchase_return_invoice_main_seq", allocationSize = 1)
