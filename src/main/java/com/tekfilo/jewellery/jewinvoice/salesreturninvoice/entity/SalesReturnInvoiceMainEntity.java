...
@Setter
@Entity
@Table(name = "tbl_jew_sales_return_invoice_main")
public class SalesReturnInvoiceMainEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "salesretinvoicemain_generator")
    @SequenceGenerator(name = "salesretinvoicemain_generator", sequenceName = "tbl_jew_sales_return_invoice_main_seq", allocationSize = 1)
