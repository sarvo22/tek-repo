...
@NoArgsConstructor
@Entity
@Table(name = "tbl_jew_sales_return_invoice_chgs")
public class SalesReturnInvoiceChargesEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "salesretinvoicechgs_generator")
    @SequenceGenerator(name = "salesretinvoicechgs_generator", sequenceName = "tbl_jew_sales_return_invoice_chgs_seq", allocationSize = 1)
