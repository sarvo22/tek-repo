...
@NoArgsConstructor
@Entity
@Table(name = "tbl_jew_memo_purchase_return_invoice_det")
public class MemoPurchaseReturnInvoiceDetailEntity {
    ...
    @SequenceGenerator(name = "memopurchaseretinvoicedet_generator", sequenceName = "tbl_jew_memo_purchase_return_invoice_det_seq", allocationSize = 1)
