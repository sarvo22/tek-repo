package com.tekfilo.jewellery.jewinvoice.memopurchasereturninvoice.entity;
...
@Setter
@Entity
@Table(name = "tbl_jew_memo_purchase_return_invoice_main")
public class MemoPurchaseReturnInvoiceMainEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "memopurchaseretinvoicemain_generator")
    @SequenceGenerator(name = "memopurchaseretinvoicemain_generator", sequenceName = "tbl_jew_memo_purchase_return_invoice_main_seq", allocationSize = 1)
    ...
    @Column(name = "total_invoice_qty", insertable = false, updatable = false)
    private BigDecimal totalInvoiceQty;
