...
public class Swagger2Configuration {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Tekfilo Jewellery Service")
                .description("Inventory service provides complete flow of Tekfilo Jewellery management")
                .license("MIT")
    ...
    public Docket docket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.tekfilo.jewellery"))
