...
@Setter
@Entity
@Table(name = "tbl_purchase_return_invoice_main")
public class PurchaseReturnInvoiceMainEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "purchaseretinvoicemain_generator")
    @SequenceGenerator(name = "purchaseretinvoicemain_generator", sequenceName = "tbl_purchase_return_invoice_main_seq", allocationSize = 1)
