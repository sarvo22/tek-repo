...
@NoArgsConstructor
@Entity
@Table(name = "tbl_purchase_return_invoice_chgs")
public class PurchaseReturnInvoiceChargesEntity {
    ...
    @SequenceGenerator(name = "purchaseretinvoicechgs_generator", sequenceName = "tbl_purchase_return_invoice_chgs_seq", allocationSize = 1)
