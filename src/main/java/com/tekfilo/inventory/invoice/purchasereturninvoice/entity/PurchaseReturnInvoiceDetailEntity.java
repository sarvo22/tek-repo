package com.tekfilo.inventory.invoice.purchasereturninvoice.entity;
...
@Data
@Entity
@Table(name = "tbl_purchase_return_invoice_det")
public class PurchaseReturnInvoiceDetailEntity {

    @Transient
    PurchaseInvoiceMainEntity purchaseInvoiceMain;

    @Transient
    PurchaseReturnInvoiceMainEntity purchaseReturnInvoiceMain;

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "purchaseretinvoicedet_generator")
    @SequenceGenerator(name = "purchaseretinvoicedet_generator", sequenceName = "tbl_purchase_return_invoice_det_seq", allocationSize = 1)
