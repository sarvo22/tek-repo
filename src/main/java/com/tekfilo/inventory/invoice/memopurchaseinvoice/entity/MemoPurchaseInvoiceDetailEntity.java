...
@NoArgsConstructor
@Entity
@Table(name = "tbl_memo_purchase_invoice_det")
public class MemoPurchaseInvoiceDetailEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "memopurchaseinvoicedet_generator")
    @SequenceGenerator(name = "memopurchaseinvoicedet_generator", sequenceName = "tbl_memo_purchase_invoice_det_seq", allocationSize = 1)
