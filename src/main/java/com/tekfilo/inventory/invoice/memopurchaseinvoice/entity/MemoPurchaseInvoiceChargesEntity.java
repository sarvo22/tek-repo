...
@NoArgsConstructor
@Entity
@Table(name = "tbl_memo_purchase_invoice_chgs")
public class MemoPurchaseInvoiceChargesEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "memopurchaseinvoicechgs_generator")
    @SequenceGenerator(name = "memopurchaseinvoicechgs_generator", sequenceName = "tbl_memo_purchase_invoice_chgs_seq", allocationSize = 1)
