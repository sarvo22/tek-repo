...
@NoArgsConstructor
@Entity
@Table(name = "tbl_memo_sales_invoice_chgs")
public class MemoSalesInvoiceChargesEntity {
    ...
    @SequenceGenerator(name = "memosalesinvoicechgs_generator", sequenceName = "tbl_memo_sales_invoice_chgs_seq", allocationSize = 1)
