...
@NoArgsConstructor
@Entity
@Table(name = "tbl_memo_sales_invoice_det")
public class MemoSalesInvoiceDetailEntity {
    ...
    @SequenceGenerator(name = "memosalesinvoicedet_generator", sequenceName = "tbl_memo_sales_invoice_det_seq", allocationSize = 1)
