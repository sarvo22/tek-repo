...
@NoArgsConstructor
@Entity
@Table(name = "tbl_sales_return_invoice_chgs")
public class SalesReturnInvoiceChargesEntity {
    ...
    @SequenceGenerator(name = "salesretinvoicechgs_generator", sequenceName = "tbl_sales_return_invoice_chgs_seq", allocationSize = 1)
