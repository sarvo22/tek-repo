...
@Setter
@Entity
@Table(name = "tbl_sales_return_invoice_main")
public class SalesReturnInvoiceMainEntity {
    ...
    @SequenceGenerator(name = "salesretinvoicemain_generator", sequenceName = "tbl_sales_return_invoice_main_seq", allocationSize = 1)
