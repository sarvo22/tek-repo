package com.tekfilo.inventory.invoice.purchaseinvoice.entity;
...
@Setter
@Entity
@Table(name = "tbl_purchase_invoice_main")
public class PurchaseInvoiceMainEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "purchaseinvoicemain_generator")
    @SequenceGenerator(name = "purchaseinvoicemain_generator", sequenceName = "tbl_purchase_invoice_main_seq", allocationSize = 1)
...
//    @OneToMany(targetEntity = PurchaseInvoiceDetailEntity.class, fetch = FetchType.LAZY)
//    @JoinColumn(name = "inv_id", referencedColumnName = "inv_id", insertable = false, updatable = false)
//    private List<PurchaseInvoiceDetailEntity> detailEntityList;
