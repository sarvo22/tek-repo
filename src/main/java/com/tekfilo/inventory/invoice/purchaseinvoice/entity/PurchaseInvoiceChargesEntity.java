...
@NoArgsConstructor
@Entity
@Table(name = "tbl_purchase_invoice_chgs")
public class PurchaseInvoiceChargesEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "purchaseinvoicechgs_generator")
    @SequenceGenerator(name = "purchaseinvoicechgs_generator", sequenceName = "tbl_purchase_invoice_chgs_seq", allocationSize = 1)
