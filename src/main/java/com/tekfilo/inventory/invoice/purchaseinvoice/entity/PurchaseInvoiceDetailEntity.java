...
@Data
@Entity
@Table(name = "tbl_purchase_invoice_det")
public class PurchaseInvoiceDetailEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "purchaseinvoicedet_generator")
    @SequenceGenerator(name = "purchaseinvoicedet_generator", sequenceName = "tbl_purchase_invoice_det_seq", allocationSize = 1)
    ...
    private PurchaseInvoiceMainEntity purchaseInvoiceMain;
