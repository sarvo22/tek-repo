...
@Setter
@Entity
@Table(name = "tbl_memo_purchase_return_invoice_main")
public class MemoPurchaseReturnInvoiceMainEntity {
    ...
    @SequenceGenerator(name = "memopurchaseretinvoicemain_generator", sequenceName = "tbl_memo_purchase_return_invoice_main_seq", allocationSize = 1)
