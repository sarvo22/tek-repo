...
@NoArgsConstructor
@Entity
@Table(name = "tbl_memo_purchase_return_invoice_chgs")
public class MemoPurchaseReturnInvoiceChargesEntity {
    ...
    @SequenceGenerator(name = "memopurchaseretinvoicechgs_generator", sequenceName = "tbl_memo_purchase_return_invoice_chgs_seq", allocationSize = 1)
