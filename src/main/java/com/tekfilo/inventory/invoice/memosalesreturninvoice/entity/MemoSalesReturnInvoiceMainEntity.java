...
@Setter
@Entity
@Table(name = "tbl_memo_sales_return_invoice_main")
public class MemoSalesReturnInvoiceMainEntity {
    ...
    @SequenceGenerator(name = "memosalesretinvoicemain_generator", sequenceName = "tbl_memo_sales_return_invoice_main_seq", allocationSize = 1)
