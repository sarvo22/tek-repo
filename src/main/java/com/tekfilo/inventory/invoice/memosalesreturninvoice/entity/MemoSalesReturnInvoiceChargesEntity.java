...
@NoArgsConstructor
@Entity
@Table(name = "tbl_memo_sales_return_invoice_chgs")
public class MemoSalesReturnInvoiceChargesEntity {
    ...
    @SequenceGenerator(name = "memosalesretinvoicechgs_generator", sequenceName = "tbl_memo_sales_return_invoice_chgs_seq", allocationSize = 1)
