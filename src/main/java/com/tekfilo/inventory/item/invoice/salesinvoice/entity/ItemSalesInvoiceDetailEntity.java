...
@Setter
@Entity
@Table(name = "tbl_item_sales_invoice_det")
public class ItemSalesInvoiceDetailEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "itemsalesinvoicedet_generator")
    @SequenceGenerator(name = "itemsalesinvoicedet_generator", sequenceName = "tbl_item_sales_invoice_det_seq", allocationSize = 1)
    ...
    private ItemSalesInvoiceMainEntity salesInvoiceMain;
