package com.tekfilo.inventory.item.invoice.salesinvoice.entity;
...
@Setter
@Entity
@Table(name = "tbl_item_sales_invoice_main")
public class ItemSalesInvoiceMainEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "itemsalesinvoicemain_generator")
    @SequenceGenerator(name = "itemsalesinvoicemain_generator", sequenceName = "tbl_item_sales_invoice_main_seq", allocationSize = 1)
