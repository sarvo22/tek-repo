...
@Setter
@Entity
@Table(name = "tbl_item_purchase_return_invoice_main")
public class ItemPurchaseReturnInvoiceMainEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "itempurchaseretinvoicemain_generator")
    @SequenceGenerator(name = "itempurchaseretinvoicemain_generator", sequenceName = "tbl_item_purchase_return_invoice_main_seq", allocationSize = 1)
