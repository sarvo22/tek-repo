package com.tekfilo.inventory.item.invoice.salesreturn.entity;
...
@Setter
@Entity
@Table(name = "tbl_item_sales_return_invoice_det")
public class ItemSalesReturnInvoiceDetailEntity {

    @Transient
    ItemSalesInvoiceMainEntity salesInvoiceMain;

    @Transient
    ItemSalesReturnInvoiceMainEntity salesReturnInvoiceMain;


    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "itemsalesretinvoicedet_generator")
    @SequenceGenerator(name = "itemsalesretinvoicedet_generator", sequenceName = "tbl_item_sales_return_invoice_det_seq", allocationSize = 1)
