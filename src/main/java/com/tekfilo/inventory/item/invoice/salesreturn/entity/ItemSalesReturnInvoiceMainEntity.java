...
@Setter
@Entity
@Table(name = "tbl_item_sales_return_invoice_main")
public class ItemSalesReturnInvoiceMainEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "itemsalesretinvoicemain_generator")
    @SequenceGenerator(name = "itemsalesretinvoicemain_generator", sequenceName = "tbl_item_sales_return_invoice_main_seq", allocationSize = 1)
