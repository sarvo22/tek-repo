...
@Setter
@Entity
@Table(name = "tbl_item_purchase_return_invoice_chgs")
public class ItemPurchaseReturnInvoiceChargesEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "itempurchaseretinvoicechgs_generator")
    @SequenceGenerator(name = "itempurchaseretinvoicechgs_generator", sequenceName = "tbl_item_purchase_return_invoice_chgs_seq", allocationSize = 1)
