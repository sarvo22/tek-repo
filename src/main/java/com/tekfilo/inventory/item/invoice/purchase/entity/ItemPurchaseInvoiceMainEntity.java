...
@Setter
@Entity
@Table(name = "tbl_item_purchase_invoice_main")
public class ItemPurchaseInvoiceMainEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "itempurchaseinvoicemain_generator")
    @SequenceGenerator(name = "itempurchaseinvoicemain_generator", sequenceName = "tbl_item_purchase_invoice_main_seq", allocationSize = 1)
