...
@Setter
@Entity
@Table(name = "tbl_bin_transfer_det")
public class BinTransferDetailEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "bintransferdet_generator")
    @SequenceGenerator(name = "bintransferdet_generator", sequenceName = "tbl_bin_transfer_det_seq", allocationSize = 1)
    ...
    @Column(name = "transfer_qty1")
    private Double transferQty1;

    @Column(name = "transfer_qty2")
