package com.tekfilo.inventory.config;
...
public class Swagger2Configuration {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Tekfilo Inventory Service")
                .description("Inventory service provides complete flow of Tekfilo Product Inventory and Invoice management")
                .license("MIT")
    ...
    public Docket docket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.tekfilo.inventory"))
