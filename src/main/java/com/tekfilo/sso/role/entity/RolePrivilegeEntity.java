...
public class RolePrivilegeEntity {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "roleprivilege_generator")
    @SequenceGenerator(name = "roleprivilege_generator", sequenceName = "tbl_role_privilege_seq", allocationSize = 1)
    ...
    @Column(name = "privilege_id", insertable = true, updatable = false)
